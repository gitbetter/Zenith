...
public:
  ...
  float ResolutionXRatio() const { return (float)resolutionX_ / ZEngine::DEFAULT_X_RESOLUTION; }
  float ResolutionYRatio() const { return (float)resolutionY_ / ZEngine::DEFAULT_Y_RESOLUTION; }
