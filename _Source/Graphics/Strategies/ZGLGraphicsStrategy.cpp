...
ZBufferData ZGLGraphicsStrategy::LoadVertexData(std::vector<glm::vec4> vertices) {
  ZBufferData bufferData;
  glGenBuffers(1, &bufferData.vbo);
  ...
  // Vertex textures coordinates
  glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, sizeof(float), (void*)(2 * sizeof(float)));
  glEnableVertexAttribArray(1);
