...
// Definitions
class ZIntField : public ZTypedEditorControl<ZUIInputField, int> {
...
public:
    ...
    static std::shared_ptr<ZIntField> Create(const std::string& label = "", const std::shared_ptr<ZScene>& scene = nullptr, ZUITheme theme = ZUITheme());
